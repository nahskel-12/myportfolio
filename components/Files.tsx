...
const filesData: PortfolioFile[] = [
    ...
    { id: 4, title: 'Organic Chemistry Reactions', description: 'High-resolution visual guide to common organic chemistry reactions and mechanisms.', type: FileType.IMAGE, subject: FileSubject.CHEMISTRY, url: '#' },
    ...
    { id: 8, title: 'Quantum Mechanics Intro', description: 'An introductory research paper on the fundamental concepts of quantum mechanics.', type: FileType.PDF, subject: FileSubject.PHYSICS, url: '#' },
